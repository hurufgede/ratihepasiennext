...
<div class="form-container">
    <h2 class="form-title">Tambah Pengumuman</h2>
    ...
    <form action="{{ route('admin.announcements.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" class="input-field" placeholder="Contoh: Jadwal Libur Hari Raya Idul Fitri" value="{{ old('title') }}" required>
        </div>

        <div class="form-group">
            <label class="form-label">Isi / Konten Pengumuman</label>
            <textarea name="content" rows="6" class="input-field" placeholder="Tuliskan detail pengumuman di sini..." required>{{ old('content') }}</textarea>
        </div>
